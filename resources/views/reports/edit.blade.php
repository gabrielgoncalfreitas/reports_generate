                            ...
                            <form>
                                <div class="modal-body">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control ajaxDisabled" id="firstNameFloating"
                                            placeholder="First name" name="first_name">
                                        <label for="firstNameFloating">First name</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control ajaxDisabled" id="lastNameFloating"
                                            placeholder="First name" name="last_name">
                                        <label for="lastNameFloating">Last name</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="date" class="form-control ajaxDisabled" id="dboFloating"
                                            placeholder="First name" name="dbo">
                                        <label for="dboFloating">Date of birth</label>
                                    </div>
                                    <select class="form-select ajaxDisabled" aria-label="Default select example"
                                        name="gender">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success ajaxDisabled" onclick="disable()">
                                        Save changes
                ...
                @foreach ($data as $_data)
                    ...
                    <div class="modal fade" id="editProfile{{ $_data->id }}Modal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editProfile{{ $_data->id }}ModalLabel">Create
                                        profile</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <form action="/profile/update/{{ $_data->id }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="lastNameFloating"
                                                placeholder="First name" name="last_name"
                                                value="{{ $_data->last_name }}">
                                            <label for="lastNameFloating">Last name</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="date" class="form-control" id="dboFloating"
                                                placeholder="First name" name="dbo" value="{{ $_data->dbo }}">
                                            <label for="dboFloating">Date of birth</label>
                                        </div>
